...
<img height="30" class="pe-app-sidebar-logo-minimize-light d-none" alt="Logo" src="{{ asset('assets/images/logo-md-light.png') }}">
           ...
           <br>
            ...
            <li class="pe-slide pe-has-sub">
                <a href="#collapseEcommerce" class="pe-nav-link" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseEcommerce">
                    ...
                    <span class="pe-nav-content">Administration</span>
                    <i class="ri-arrow-down-s-line pe-nav-arrow"></i>
                </a>
                <ul class="pe-slide-menu collapse" id="collapseEcommerce">
                     <li class="pe-slide-item">
                        <a href="{{ route('AddEmployee') }}" class="pe-nav-link">
                            Add Employee
                        </a>
                    </li>
                    <li class="pe-slide-item">
                        <a href="{{ route('ManageEmployees') }}" class="pe-nav-link">
                            Manage Employees
                        </a>
                    </li>
                   
                    <li class="pe-slide-item">
                        <a href="{{ route('AddAsset') }}" class="pe-nav-link">
                            Add Assets
                        </a>
                    </li>
                    <li class="pe-slide-item">
                        <a href="{{ route('ManageAssets') }}" class="pe-nav-link">
                            Manage Assets
                        </a>
                    </li>
                    <li class="pe-slide-item">
                        <a href="{{ route('attendance.view') }}" class="pe-nav-link">
                           Attendance Report
                        </a>
                    </li>
                    <li class="pe-slide-item">
                        <a href="{{ route('department.create') }}" class="pe-nav-link">
                            Create Departments
                        </a> 
                    </li>
                       <li class="pe-slide-item">
                        <a href="{{ route('departments.manage') }}" class="pe-nav-link">
                            Manage Departments
                        </a>
                    </li>
                     <li class="pe-slide-item">
    ...
    Leave Applications
                    ...
                    <li class="pe-slide-item">
                        <a href="{{ route('fleet.index') }}" class="pe-nav-link">
                           Fleet Management                        
                        </a>
                    </li>
                   ...
                   <li class="pe-slide-item">
                    <a href="{{ url('/mothers-day') }}" class="pe-nav-link">
                       Mother's Day
                    </a>
                 </li>
                      @endif
...
<br>
            ...
            <li class="pe-slide pe-has-sub">
                <a href="#collapseAcademy" class="pe-nav-link" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseEcommerce">
                    <i class="bi bi-basket pe-nav-icon"></i>
                    <span class="pe-nav-content">Inventory Management</span>
                    <i class="ri-arrow-down-s-line pe-nav-arrow"></i>
                </a>
                <ul class="pe-slide-menu collapse" id="collapseAcademy">
                     <li class="pe-slide-item">
                        <a href="{{ route('products.create') }}" class="pe-nav-link">
                            Add Item
                        </a>
                    </li>
                    <li class="pe-slide-item">
                        <a href="{{ route('inventorytable') }}"  class="pe-nav-link">
                            View Items
                        </a>
                    </li>
                   
                    <li class="pe-slide-item">
                        <a href="{{ route('stock') }}" class="pe-nav-link">
                            Add Stock
                        </a>
                    </li>
                    <li class="pe-slide-item">
                        <a href="{{ route('stock-requests.history') }}" class="pe-nav-link">
                    ...
                    <li class="pe-slide-item">
                        <a href="{{ route('stockrequest') }}" class="pe-nav-link">
                            Job Cards Request
                        </a>
                    </li>
                     <li class="pe-slide-item">
                        <a href="{{ route('ProductionRequest.material') }}" class="pe-nav-link">
                            Material Request                        </a>
                    </li>
                    <!-- <li class="pe-slide-item">
...
<br>
             ...
             <li class="pe-slide pe-has-sub">
                <a href="#collapseCMS" class="pe-nav-link" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseEcommerce">
                    <i class="bi bi-printer pe-nav-icon"></i>
                    <span class="pe-nav-content">Production</span>
                    <i class="ri-arrow-down-s-line pe-nav-arrow"></i>
                </a>
                <ul class="pe-slide-menu collapse" id="collapseCMS">
                     <li class="pe-slide-item">
                        <a href="{{ route('CreateProject') }}" class="pe-nav-link">
                            Create Project
                        </a>
                    </li>
                    <li class="pe-slide-item">
                        <a href= "{{ route('projects.manage') }}"  class="pe-nav-link">
                            Ongoing Projects
                        </a>
                    </li>
...
<br>
                  ...
                  <li class="pe-slide pe-has-sub">
                <a href="#collapseMenuLavels" class="pe-nav-link" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseEcommerce">
...
<br>
            ...
            <li class="pe-slide pe-has-sub">
                <a href="{{ route('documentation.view') }}" class="pe-nav-link">
                    <i class="bi bi-file-earmark pe-nav-icon"></i>
                    <span  class="pe-nav-content">Rideve Documentation</span>
                </a>
