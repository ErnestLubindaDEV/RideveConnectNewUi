...
const settings = [
    ...
    // CHANGE THIS from "default" to "sm" or "compact" (depending on theme)
    { attribute: "data-sidebar-size", defaultValue: "sm" }, 
    { attribute: "data-sidebar-color", defaultValue: "default" },
    // CHANGE THIS from "light" to "icon" to trigger the collapsed version
    { attribute: "data-sidebar", defaultValue: "icon" }, 
